...
Namespace Futronic.SDK.WorkedEx
	...
	Public Class DbRecord
		...
		Private Sub Load(ByVal szFileName As String)
			Using fileStream As FileStream = New FileStream(szFileName, FileMode.Open)
		...
		Public Function Save(ByVal szFileName As String) As Boolean
			...
			End If
			Using fileStream As FileStream = New FileStream(szFileName, FileMode.Create)
				Dim utfEncoder As UTF8Encoding = New UTF8Encoding()
				Dim Data As Byte() = Nothing
		...
		''' </returns>
		Public Shared Function ReadRecords(ByVal szDbDir As String) As List(Of DbRecord)
			Dim Users As List(Of DbRecord) = New List(Of DbRecord)(10)
