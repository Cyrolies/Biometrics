...
namespace SDKHelper {
	...
	// template.
    ///</summary>
    public __gc class FutronicVerification : public FutronicSdkBase
    {
    public:

        ///<summary>
		/// This __event is signaled when the verification operation is completed.
        ///</summary>
        __event OnVerificationCompleteHandler * OnVerificationComplete;
        ...
        /// the constructor.
        ///</exception>
        FutronicVerification( Byte Template[] )
            : FutronicSdkBase()
        {
            if( Template == nullptr )
                throw __gc new ArgumentNullException( "Template" );
            m_Template = (Byte[])Template->Clone();
            m_FARNValue = 1;
            m_bResult = false;
        }
        ...
        void Verification()
        {
            ...
            m_WorkedThread = __gc new Thread( __gc new ThreadStart( this, &Futronic::SDKHelper::FutronicVerification::VerificationThreadStartProc ) );
