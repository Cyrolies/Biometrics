...
function weGetErrorText( rCode: FTRAPI_RESULT ): String;
procedure PrintTextMsg( lpTextMsg: String );
...
var
   ...
   errTitle:   String;                 // error tytle for MessageBox
begin
   // get error text
   ...
   begin
      ...
      MessageBox( 0, PChar( errText ), PChar( errTitle ),
