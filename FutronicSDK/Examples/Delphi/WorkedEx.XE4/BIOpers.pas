...
uses
   Windows, SysUtils, Dialogs, Forms, AnsiStrings,
...
begin
   ...
   begin
      ...
      AnsiStrings.StrCopy( idRec.KeyValue, lpDBR.key );
      ...
      begin
         ...
         StrCat( msg, PChar( String( resArrX.pMembers.KeyValue ) ) );
         StrCat( msg, ' (' );
         // FAR or FARN choise
         //StrCat( msg, CalcMfromP( resArr.pMembers.FarAttained ) );
         sFARN := IntToStr( resArrX.pMembers.FarAttained );
         StrPCopy( cFARN, sFARN );
         StrCat( msg, cFARN );
         StrCat( msg, ')' );
         PrintTextMsg( msg );
